...
and feature-specific logic is moved into dedicated AddOns. This AddOn model makes it possible to integrate and evolve backends such as DX11, DX12, 
...
abstractions, while the actual execution is still handled by the respective graphics backends. This keeps the engine more flexible, easier to maintain, 
